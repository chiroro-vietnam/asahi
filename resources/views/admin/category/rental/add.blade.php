  ...
  <tr>
    ...
    <td><table width="100%" border="1" cellspacing="0" cellpadding="5">
      <tr>
        ...
        <td>
            <input name="name" type="text" id="name" size="60" value="{{Input::old('name')}}" />
            <input name="order" type="hidden" id="order" size="60" value="{{$order}}" />
        </td>
      </tr>
      <tr>
        <td width="20%" class="col3">表示設定</td>
        <td>
            <input type="checkbox" name="display" id="display" <?php if (Input::old('display') == 1) echo 'checked'; ?>/>
          一時的に一般側画面へ表示しない</td>
      </tr>
